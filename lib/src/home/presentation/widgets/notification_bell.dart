...
import 'package:education_app/src/notifications/presentation/views/notifications_view.dart';
import 'package:flutter/material.dart' hide Badge;
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:iconly/iconly.dart';

/// A widget that displays a notification bell icon with a badge indicating the
...
class _NotificationBellState extends State<NotificationBell> {
  ...
  void initState() {
    ...
    // Fetches notifications from the notification cubit.
    context.read<NotificationCubit>().getNotifications();

    // Listens for changes in new notifications and plays a notification sound
    // if needed.
